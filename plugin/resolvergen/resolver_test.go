...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "github.com/00security/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func testFollowSchemaPersistence(t *testing.T, dir string) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/00security/gqlgen/plugin/resolvergen/"+dir+"/out")
}
