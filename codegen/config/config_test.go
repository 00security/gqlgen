...
func TestAutobinding(t *testing.T) {
	t.Run("valid paths", func(t *testing.T) {
		...
		require.Equal(t, "github.com/00security/gqlgen/example/scalars/model.Banned", cfg.Models["Banned"].Model[0])
		require.Equal(t, "github.com/00security/gqlgen/example/chat.Message", cfg.Models["Message"].Model[0])
	})
