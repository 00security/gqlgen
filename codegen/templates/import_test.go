...
func TestImports(t *testing.T) {
	...
	aBar := "github.com/00security/gqlgen/codegen/templates/testdata/a/bar"
	bBar := "github.com/00security/gqlgen/codegen/templates/testdata/b/bar"
	mismatch := "github.com/00security/gqlgen/codegen/templates/testdata/pkg_mismatch"
	...
	t.Run("lookup by type", func(t *testing.T) {
		...
		pkg := types.NewPackage("github.com/00security/gqlgen/codegen/templates/testdata/b/bar", "bar")
	...
	t.Run("string printing for import block", func(t *testing.T) {
		...
		require.Equal(
			t,
			`"github.com/00security/gqlgen/codegen/templates/testdata/a/bar"
bar1 "github.com/00security/gqlgen/codegen/templates/testdata/b/bar"
turtles "github.com/00security/gqlgen/codegen/templates/testdata/pkg_mismatch"`,
			a.String(),
		)
	})
